// // ignore_for_file: prefer_const_constructors, sort_child_properties_last, non_constant_identifier_names, unnecessary_string_interpolations, use_super_parameters, avoid_print, use_build_context_synchronously
...
// import 'package:food_app/Login/LoginPage.dart';
...
//       _updateUserStatus(_user!.uid, true);
//       await saveUserFcmToken(userCredential.user!.uid);
//       Get.snackbar("SignIn", "User Registered and SignIn Seccessfully",
...
//       if (_image != null) {
//         await imagestorestorage(userCredential.user!.uid);
//       }
...
//         "Type": "Users"
//       });
//     //   await saveUserFcmToken(userCredential.user!.uid); // Save FCM token for push notifications
//     //   // _updateUserStatus(userId, isLoggedIn)
//     //   _updateUserStatus(_user!.uid, true);
//     //   Get.snackbar("SignIn", "User Registered and SignIn Seccessfully",
//     //       colorText: Colors.white);
//     //   Get.offAll(LoginPage());
...
//   // Show options to choose an image source
//   imagesource() {
...
//   // Function to upload image to Firebase Storage and get the download link
//   imagestorestorage(String uid) async {
//     try {
//       FirebaseStorage storage = FirebaseStorage.instance;
//       Reference storageref =
//           storage.ref().child("User/${emailController.text.toString()}");
//       UploadTask uploadTask = storageref.putFile(_image!);
//       TaskSnapshot snapshot = await uploadTask;
//       downloadLink = await snapshot.ref.getDownloadURL();
//       print("Download Here: $downloadLink");
//       setState(() {});
//     } catch (e) {
//       print("Error: $e");
//       // Get.snackbar("Error", e.toString());
...
class _SignUpScreenState extends State<SignUpScreen> {
 ...
 Future<void> _signInWithGoogle() async {
  try {
    ...
    // Save user data to Firestore
    await _saveUserToFirestore(_user!);
    Get.snackbar("SignIn", "User Registered and Signed In Successfully",
        // colorText: 
        );
    Get.offAll(Wrapper());
  } catch (e) {
    print("Error during sign-in: $e");
    Get.snackbar("Sign-In Error", e.toString(), colorText: Colors.red);
  }
}
  ...
  Future<void> _saveUserToFirestore(User user) async {
    ...
    await userRef.set({
      ...
      'lastSignIn': FieldValue.serverTimestamp(),
      "Type": "Users",
      // 🔥 YEH LINE ZAROORI HAI GOOGLE USERS KE LIYE
      'isLoggedIn': true, 
    }, SetOptions(merge: true));
  }
}
    ...
    try {
      ...
      if (passwordController.text.isEmpty) {
        ...
        await FirebaseFirestore.instance
          ...
          "name": userController.text,
          "Email": emailController.text,
          "Password": passwordController.text, // Store hashed password
          "image": downloadLink,
          "Type": "Users",
          "isLoggedIn": true,
          "isBlocked": false,
        ...
        children: [
          ...
          Padding(
           ...
           child: FlutterPwValidator(
                        ...
                        numericCharCount: 1,
                        specialCharCount: 1,
                        failureColor: Colors.red.shade900,
                        defaultColor: Colors.red.shade900,
                        successColor: Colors.blue.shade900,
                        onSuccess: () {
                          PWValidator = true;
                        },
                        controller: passwordController,
